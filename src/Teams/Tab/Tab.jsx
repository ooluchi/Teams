    ...
    <div className={styles.right}>
      ...
      <div className="team-container">
        ...
        <div className="teams-content-tabs">
          <div
            className={
              toggleState === 1 ? 'teams-content  teams-active-content' : 'teams-content'
            }
          >
            <p>
          ...
          <div
            className={
              toggleState === 2 ? 'teams-content  teams-active-content' : 'teams-content'
            }
          >
          ...
          <div
            className={
              toggleState === 3 ? 'teams-content  teams-active-content' : 'teams-content'
            }
          >
